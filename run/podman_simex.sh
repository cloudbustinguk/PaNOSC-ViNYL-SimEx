#!/usr/bin/env bash
containername="localhost/cloudbusting/simex"
XSOCK=/tmp/.X11-unix
...
FAKE_HOME=$HOME/SimEx-podman
mkdir -p $FAKE_HOME
podman run -ti -e QT_X11_NO_MITSHM=1 -e JUPYTER_RUNTIME_DIR=/tmp -v $XSOCK:$XSOCK -v XAUTH:$XAUTH -e DISPLAY:${DISPLAY_TO_USE} -v $FAKE_HOME:/home/jovyan:Z -e XAUTHORITY=$XAUTH $DEVICESTRING -p 8080:8080 $containername jupyter notebook --allow-root --no-browser --ip 0.0.0.0 --port 8080 /home/jovyan
